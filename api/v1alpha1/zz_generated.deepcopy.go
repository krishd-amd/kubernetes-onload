...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NICKernelBuildSpec) DeepCopyInto(out *NICKernelBuildSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NICKernelBuildSpec.
func (in *NICKernelBuildSpec) DeepCopy() *NICKernelBuildSpec {
	if in == nil {
		return nil
	}
	out := new(NICKernelBuildSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OnloadKernelMapping) DeepCopyInto(out *OnloadKernelMapping) {
	*out = *in
	if in.OnloadBuild != nil {
		in, out := &in.OnloadBuild, &out.OnloadBuild
		*out = new(OnloadKernelBuildSpec)
		**out = **in
	}
	if in.NICBuild != nil {
		in, out := &in.NICBuild, &out.NICBuild
		*out = new(NICKernelBuildSpec)
		**out = **in
	}
}
